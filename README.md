...
# Securely archive QuickBooks invoices to Google Drive

[Intuz](https://www.intuz.com/) provides a complete and automated solution for secure document archiving.
...
- **Upload file (Google Drive):** In the parameters for this node, select the Folder ID where you want your invoices to be saved.
